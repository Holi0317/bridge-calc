...
const local = {
  ...
  "Hopefully your data is safe. Refresh page may fix the problem.":
    "Hopefully your data is safe. Refresh page may fix the problem.",
  ...
  // Validation messages
  "At least 2 players is required for a game":
    "At least 2 players is required for a game",
  "Too many players. Upper limit is {{limit}} players.":
    "Too many players. Upper limit is {{limit}} players.",
  ...
  "Impossible to continue the game due to too many players":
    "Impossible to continue the game due to too many players",
  ...
  "Maker edit is disabled when editing player names":
    "Maker edit is disabled when editing player names",
  ...
  "Skipped round(s). You are now playing round {{round}}":
    "Skipped round(s). You are now playing round {{round}}",
  "Already at the last round. Cannot skip.":
    "Already at the last round. Cannot skip.",
  ...
  "Error when changing language. Error: {{err}}":
    "Error when changing language. Error: {{err}}",
