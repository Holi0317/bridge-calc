...
export const routes: Route[] = [
  {
    ...
    component: Loadable({
      loader: () =>
        import("./enter" /* webpackChunkName: "score-input-enter-view" */).then(
          mod => mod.Enter
        ),
      loading: Loading
    }),
  ...
  },
  {
    ...
    component: Loadable({
      loader: () =>
        import(
          "./scoreboard" /* webpackChunkName: "score-input-scoreboard-view" */
  ...
  },
  {
    ...
    component: Loadable({
      loader: () =>
        import(
          "./settings" /* webpackChunkName: "score-input-settings-view" */
